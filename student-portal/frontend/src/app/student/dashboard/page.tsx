...
export default function DashboardPage() {
  ...
  const paymentsQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return response.data as Array<{ id: number; status: string; amountCents: number }>;
    },
    enabled: isReady
  });
    ...
    <div className="space-y-6">
      <section className="grid gap-4 md:grid-cols-3">
        <div className="card">
          ...
          <p className="mt-2 text-sm text-slate-500">Consultez vos dernières informations académiques.</p>
        </div>
        <div className="card">
        ...
        <div className="card">
          <h3 className="text-sm font-medium text-slate-500">Paiements récents</h3>
      ...
      <section className="card">
        <h2 className="text-lg font-semibold text-slate-800">Dernières notes</h2>
